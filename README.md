...
The June 7 first two slots submitted R112 and R113, both from the train+val YOLOv8n scratch checkpoint at 640 px. R112 used `conf=0.000075` with 123675 boxes; R113 used `conf=0.000060` with 136688 boxes. Both scored `0.87382`, becoming the new best public result and validating the train+val checkpoint direction.
