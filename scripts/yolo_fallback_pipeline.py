...
This fallback keeps the architecture and no-pretraining constraints for
reproducible YOLOv8n-from-scratch experiments:
...
def main() -> int:
    ...
    summary = {
        ...
        "rule_note": "YOLOv8n.yaml from scratch with no pretraining.",
    }
